...
New-Item -Path "proyecto-dockerizado\apache" -ItemType Directory -Force
New-Item -Path "proyecto-dockerizado\gitea\data" -ItemType Directory -Force

# Crear archivo apache/000-default.conf
Set-Content -Path "proyecto-dockerizado\apache\000-default.conf" -Value @'
<VirtualHost *:80>
...
APP_NAME=Laravel
APP_ENV=local
APP_KEY=base64:SAnxfIjr0k+wd9ZAIbawRrPoolbF9IkBMGu81UIeYyE=
APP_DEBUG=true
